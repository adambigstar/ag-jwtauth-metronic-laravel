...
<head>
  ...
  <link href="metronic/assets/global/css/components-rounded.min.css" id="style_components" rel="stylesheet" type="text/css" />
  ...
  <link href="metronic/assets/pages/css/login-3.min.css" rel="stylesheet" type="text/css" />
  <!-- END THEME STYLES -->
...
<body data-ng-app="MetronicApp" class="page-header-fixed page-sidebar-closed-hide-logo page-on-load" ng-class="{'page-content-white': settings.layout.pageContentWhite,'page-container-bg-solid': settings.layout.pageBodySolid, 'page-sidebar-closed': settings.layout.pageSidebarClosed}">
  <!-- BEGIN PAGE SPINNER -->
  ...
  <!-- END PAGE SPINNER -->
  <ui-view ng-controller="AppController"></ui-view>
